...
function gather() {
  ...
  // capture doi and pmid if they are available
  // (used by: postRootAnnoForGene)
  ...
  } else {   // remove button, undefine injected vars
    alert(`
      The window containing the ClinGen app is closed. 
      So the ClinGen bookmarklet is removing itself.
      Click the bookmarklet again to relaunch the ClinGen app.`
    );
    remove();
  }
